...
export 'video_user_model.dart';

class VideoUserWidget extends StatefulWidget {
  const VideoUserWidget({super.key});

  @override
  State<VideoUserWidget> createState() => _VideoUserWidgetState();
}

class _VideoUserWidgetState extends State<VideoUserWidget> {
  late VideoUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoUserModel());
  }
